...
const translations = {
  en: {
    ...
    'button.deleteAbsence': 'Delete Absence',
    'button.close': 'Close',
    'button.save': 'Save',
    ...
    'calendar.addAbsence': 'Add absence',
    ...
    // Settings
    'settings.title': 'Manage Absence Types',
    'settings.subtitle': 'Here you can create, edit and manage absence types.',
    'settings.calendar': 'Calendar Settings',
    'settings.weekStartsOn': 'Week starts on:',
    'settings.monday': 'Monday',
    'settings.sunday': 'Sunday',
    'settings.showInactive': 'Show inactive types',
  ...
  de: {
    ...
    'button.deleteAbsence': 'Abwesenheit löschen',
    ...
    'stats.totalDays': 'Gesamttage',
    'stats.daysByType': 'Tage nach Typ',
    ...
    // Settings
    'settings.title': 'Abwesenheitstypen verwalten',
    'settings.subtitle': 'Hier können Sie Abwesenheitstypen erstellen, bearbeiten und verwalten.',
    ...
    'settings.showInactive': 'Inaktive Typen anzeigen',
